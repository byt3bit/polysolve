The relation between LWE, RingLWE and Module LWE is well known, and it is often possible to reduce one problem to another.
\[
\text{LWE} \;\xrightarrow{\; k=1,\; n=1 \;}\; \text{Module-LWE} \;\xrightarrow{\; k=1 \;}\; \text{Ring-LWE}
\]
