...
Each equation, due to diagonalization process, is of the form $a_i x_i -b_i$ for $i \in \{1,\dots,n\}$, and the secret is uniquely determined as $\vars{s} = (s_1, \dots, s_n)$, with $s_i = a_i^{-1}b_i \pmod q$ as described in \Cref{subsec:highlevel}.
