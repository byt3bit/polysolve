...
Each equation, due to diagonalization process, is of the form $x_i - s_i$ \mlf{$a_jx_j - s_j$} for $i \in \{1,\dots,n\}$, and the secret is uniquely determined as $\vars{s} = (s_1, \dots, s_n)$.
\mlf{not directly $s_j$.}
