...
to general RLWE. While previous algebraic algorithms and their refinements uses polynomial system solving techniques that are applicable when the co-efficients are in $\F_q$
