...
\hline
RLWE & $N$  & $\binom{N+d-1}{d}$ & $\bigO\left(N^{\max(3(d-1), d\omega)}\right)$ & $\bigO\left(q\log(q)N^d\right)$ & $\bigO\left(q\log(q)N^{d\omega}\right)$\\
\hline
MLWE & $Nn$  & $\binom{Nn+d-1}{d}$ & $\bigO\left((Nn)^{\max(3(d-1), d\omega)}\right)$ & $\bigO\left(q\log(q)(Nn)^d\right)$ & $\bigO\left(q\log(q)(Nn)^{d\omega}\right)$\\
\hline\hline
    \end{tabular}
