...
\noindent
\textbf{\textsf{Hardness and Cryptographic Application.}}
...
\hline\hline
~\cite{ICALP:AroGe11} & $d$ & $\mathcal{O}(\log(q)\cdot q\cdot n^d)$ & $\mathcal{O}\Big(\log(q)\cdot q\cdot n^{\omega d}\Big)$ &\cellcolor{lipicsLightGray} \notused&\cellcolor{lipicsLightGray} \YES\\ 
\hline
~\cite{EPRINT:Steiner24b} & $d$ & $m>n$ & $\mathcal{O}\Big( m\cdot (d-1)\cdot n\cdot 2^{\omega\cdot{(8d\ln(4)-1)}^{1/\ln(4)}\cdot n} \Big)$ & \cellcolor{lipicsLightGray}\notused& \NO\\
\hline
~\cite{EPRINT:Steiner24b} & $d$ & $\mathcal{O}\Big( \binom{n+d-1}{d} \Big)$ & $\mathcal{O}\Big(d^3\cdot c_d^{{(n-1)}^{1-1/\ln(4)}}\Big)$ & \used& \NO\\
\hline
~\cite{EC:NMSU25} & $d$ & $\binom{n+d-1}{d}$ & $\mathcal{O}\Big(dn^{1+d\omega}\Big)$ & \cellcolor{lipicsLightGray}\notused& \NO\\
\hline
This Work & $d$ & $\mathcal{O}\left(\binom{n+d-1}{d}\right)$ & $\mathcal{O}\Big(\binom{n+d}{d}^3\Big) $ &\cellcolor{lipicsLightGray} \notused&\cellcolor{lipicsLightGray}\YES\\
\hline\hline
...
\hline
This Work & $2$ & $\mathcal{O}\left(\frac{n(n-1)}{2}\right)$ & $\mathcal{O}\Big(\binom{n+2}{2}^3\Big) $ &\cellcolor{lipicsLightGray} \notused&\cellcolor{lipicsLightGray} \YES\\
\hline\hline\\
    \end{tabular}
...
\noindent
\textbf{\textsf{Linearization Technique~\cite{ICALP:AroGe11}.}} 
...
\noindent
\textbf{\textsf{Gr{\"o}bner Basis and Degree of Regularity.}}
