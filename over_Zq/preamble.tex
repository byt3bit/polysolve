...
\newcommand{\mlf}[1]{\textcolor{orange}{MX: #1}}
...
\newcommand{\srlwe}{search-RLWE} 
\newcommand{\smlwe}{search-MLWE} 
\newcommand{\belwe}{BinaryError-LWE}
\newcommand{\bslwe}{BinarySecret-LWE}
\newcommand{\mlwe}{\text{MLWE}}
...
\newcommand{\algspoly}{\texttt{Spoly}}
\newcommand{\algdiag}{\texttt{Diag}}
...
\algnewcommand{\GetsIfThenElse}[3]{% \IfThenElse{<if>}{<then>}{<else>}
   #1\ \algorithmicif\ #2 \algorithmicelse\ #3}
