...
\node[matparens] (A1) {
    \begin{tikzpicture}
% <<<<<<< HEAD
%         \node[gray, matrix={1}{1}, fill=gray] (R) {};
% =======
        \node[gray, matrix={1}{1}, fill=lightgray] (R) {};
        ...
        \node[gray, matrix={1}{3}, fill=lightgray, right=1mm of R] (T) {};
...
\node[matparens, below=of A1] (B2) {
    \begin{tikzpicture}
        ...
        \node[gray, matrix={1}{3}, fill=lightgray, right=1mm of P] (L) {};
...
\draw[arrow]
  (A1.south) -- (B2.north)
  node[midway, right=1mm, font=\scriptsize, align=center] {\texttt{Diag}};
...
%     \node[font=\footnotesize, fill=white, draw=gray, line width=0.4pt, inner sep=1pt, anchor=center] at (K.center) {$i+1$};
% =======
    \node[gray, matrix={0.7}{1}, fill=lightgray] (K) {};
    \node[font=\footnotesize, fill=white, draw=lipicsGray, line width=0.4pt, inner sep=1pt, anchor=center] at (K.center) {$i+1$};
    
    \node[gray, matrix={0.7}{0.7}, fill=lightgray, right=1mm of K] (R) {};
    \draw[gray, line width=0.70mm] (R.north west) -- (R.south east) -- cycle;
    \node[font=\footnotesize, fill=white, draw=gray, line width=0.4pt, inner sep=1pt, anchor=center] at (R.center) {$i$};


    \node[gray, matrix={0.7}{2.2}, fill=lightgray, right=1mm of R] (T) {};
...
\node[matparens, below=of B3] (AA1) {
    \begin{tikzpicture}
        ...
        \node[gray, matrix={0.7}{2.2}, fill=lightgray, right=1mm of P] (L) {};
