...
\node[matparens] (A1) {
    \begin{tikzpicture}
        \node[lipicsGray, matrix={1}{1}, fill=lipicsBulletGray] (R) {};
        \draw[lipicsGray, line width=0.70mm] (R.north west) -- (R.south east) -- cycle;
        \node[font=\footnotesize, fill=white, draw=lipicsGray, line width=0.4pt, inner sep=1pt] at (R.center) {$i+1$};

        \node[lipicsBulletGray, matrix={1}{3}, fill=lipicsLightGray, right=1mm of R] (T) {};
...
\node[matparens, below=of A1] (B2) {
    \begin{tikzpicture}
        ...
        \node[font=\footnotesize, fill=white, draw=lipicsGray, line width=0.4pt, inner sep=1pt, anchor=center] at (P.center) {$i+1$};

        \node[lipicsBulletGray, matrix={1}{3}, fill=lipicsLightGray, right=1mm of P] (L) {};
...
\node[matparens, below=of B3] (AA1) {
    \begin{tikzpicture}
        ...
        \node[lipicsGray, matrix={0.7}{0.7}, fill=white, right=1mm of K] (P) {};
        \draw[lipicsGray, line width=0.70mm] (P.north west) -- (P.south east) -- cycle;
        \node[font=\footnotesize, fill=white, draw=lipicsGray, line width=0.4pt, inner sep=1pt, anchor=center] at (P.center) {$i$};

        \node[lipicsBulletGray, matrix={0.7}{2.2}, fill=lipicsLightGray, right=1mm of P] (L) {};
